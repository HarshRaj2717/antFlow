...
import { TextField, Button, MenuItem, Select, FormControl, FormHelperText, Box, ListItemText, Checkbox } from "@mui/material";
import './style.css'; 
    ...
    <Box className="container">
      ...
      <FormControl fullWidth margin="normal"> 
          <Select
            ...
            renderValue={(selected) => {
              if (selected.length === 0) {
                return <em style={{color:"gray"}}>Select your skills</em>; 
              }
          ...
          <MenuItem value="Project Management">
            <Checkbox checked={selectedSkills.indexOf("Project Management") > -1} />
            <ListItemText primary="Project Management" />
          </MenuItem>
          <MenuItem value="Requirement Gathering">
            <Checkbox checked={selectedSkills.indexOf("Requirement Gathering") > -1} />
            <ListItemText primary="Requirement Gathering" />
          </MenuItem>
          <MenuItem value="Stakeholder Communication">
            <Checkbox checked={selectedSkills.indexOf("Stakeholder Communication") > -1} />
          ...
          <MenuItem value="Cloud Infrastructure">
            <Checkbox checked={selectedSkills.indexOf("Cloud Infrastructure") > -1} />
            <ListItemText primary="Cloud Infrastructure" />
          </MenuItem>
          <MenuItem value="AGILE Methodologies">
            <Checkbox checked={selectedSkills.indexOf("AGILE Methodologies") > -1} />
            <ListItemText primary="AGILE Methodologies" />
          </MenuItem>
          <MenuItem value="Version Control (Git)">
            <Checkbox checked={selectedSkills.indexOf("Version Control (Git)") > -1} />
            <ListItemText primary="Version Control (Git)" />
          </MenuItem>
          <MenuItem value="Technical Writing">
            <Checkbox checked={selectedSkills.indexOf("Technical Writing") > -1} />
            <ListItemText primary="Technical Writing" />
          </MenuItem>
          <MenuItem value="Documentation">
            <Checkbox checked={selectedSkills.indexOf("Documentation") > -1} />
            <ListItemText primary="Documentation" />
          </MenuItem>
          <MenuItem value="Team Coordination">
            <Checkbox checked={selectedSkills.indexOf("Team Coordination") > -1} />
            <ListItemText primary="Team Coordination" />
          </MenuItem>
          <MenuItem value="Communication Skills">
            <Checkbox checked={selectedSkills.indexOf("Communication Skills") > -1} />
