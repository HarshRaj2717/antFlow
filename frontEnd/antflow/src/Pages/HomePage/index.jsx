  ...
  >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          />
          <Typography variant="h4" sx={{ fontWeight: 'bold' }}>ANTFLOW</Typography>
        </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px' }}>
        ...
        >
          <Button variant="contained" color="secondary" fullWidth onClick={handleAddNewEmployee}>
            ADD NEW EMPLOYEE
          </Button>
        ...
        >
          <Button variant="contained" color="secondary" fullWidth onClick={handleAddNewProject}>
            CREATE NEW PROJECT
          </Button>
